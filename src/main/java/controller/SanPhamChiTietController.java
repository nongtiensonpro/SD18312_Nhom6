...
public class SanPhamChiTietController {
    ...
    public boolean themSanPhamChiTietNew(SanPhamNew sanPhamNewInput) {
    ...
    public List<SanPhamNew> getAllSanPhamChiTiet() {

        Connection connection = null;
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        List<SanPhamNew> sanPhamList = new ArrayList<>();
    ...
    public boolean updateSanPhamChiTiet(SanPhamNew sanPhamNewInput) {
    ...
    public List<SanPhamNew> timSanPhamChiTietGanDung(String maSanPhamChiTiet) {
        Connection connection = null;
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        List<SanPhamNew> danhSachSanPham = new ArrayList<>();
