 ...
 */
public class YellowCatLaMeoMauVang extends javax.swing.JFrame {

    /**
     * Creates new form YellowCatLaMeoMauVang
     */
    public YellowCatLaMeoMauVang() {
        initComponents();
        themPannel();
    }
    private void themPannel(){
        JButton button = new JButton("Gau");
    ...
    private void initComponents() {
        ...
        panelChinh.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YellowCatLaMeoMauVang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new YellowCatLaMeoMauVang().setVisible(true);
            }
        });
    }
